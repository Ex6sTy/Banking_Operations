...
```
Проект предоставляет инструменты для работы с данными о финансовых операциях, включая их фильтрацию, сортировку, маскировку данных, работу с датами, генерацию данных и конвертацию валют.
