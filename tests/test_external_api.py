...
def test_read_json_valid_file():
    """
    Тест для проверки чтения корректного JSON-файла.
    """
...
def test_read_json_empty_file(tmp_path):
    """
    Тест для проверки чтения пустого JSON-файла.
    """
...
def test_read_json_invalid_format(tmp_path):
    """
    Тест для проверки чтения JSON-файла с некорректным форматом.
    """
...
def test_convert_to_rub_usd_to_rub():
    """
    Тест для проверки конвертации USD в рубли.
    """
...
def test_convert_to_rub_rub_currency():
    """
    Тест для проверки обработки транзакции в рублях без конвертации.
    """
